...
class YNet_simplified(nn.Module):
    ...
    def forward(self, x: Tuple[torch.Tensor, torch.Tensor]):
        ...
        if self.ffc:
            ...
            enc4_l, enc4_g = enc4_f
            if self.ratio_in == 0:
                enc4_f2_2 = self.pool1_f(enc4_l)
            elif self.ratio_in == 1:
                enc4_f2_2 = self.pool1_f(enc4_g)
            else:
                enc4_f2_2 = self.catLayer((self.pool4_f(enc4_l), self.pool4_f(enc4_g)))
