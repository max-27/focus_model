    ...
    def get_directories(self) -> Dict:
        ...
        for sample_box in next(os.walk(self.data_dir))[1]:
            ...
            for sample in samples:
                ...
                image_dict = {patch: 0 for patch in range(len(self.patch_coords))}
                for image in images:
                    img = io.imread(image)
                    for patch_idx, (x, y) in enumerate(self.patch_coords):
                        ...
                        if brenner_value > image_dict[patch_idx]:
                            image_dict[patch_idx] = brenner_value
...
if __name__ == "__main__":
    ...
    torch.save(dataset, "/home/maf4031/focus_model/data/test_patch_dataset.pt")
    a = 1
